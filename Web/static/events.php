...
<head>
	...
	<script type="text/javascript">
		var imgSrcs = [
			...
			"<?php bloginfo('template_url');?>/img/events/潮声潮影.jpg"
		];
	</script>
</head>
<body>
			...
			<div id='intro-wrapper' class='book-page'>
				...
				<div class='intro-event-info'>
					<div id='intro-event-logo' class='unselectable'>
						<img src='<?php bloginfo('template_url');?>/img/event-logo-yinlang.svg'/>
					</div>
				...
				<div class='intro-event-info'>
					<div id='intro-event-logo' class='unselectable'>
						<img src='<?php bloginfo('template_url');?>/img/event-logo-chaosheng.svg'/>
					</div>
					<div class='intro-event-text'>
				...
				<div class='intro-event-info'>
					<div id='intro-event-logo' class='unselectable'>
						<img src='<?php bloginfo('template_url');?>/img/event-logo-baiye.svg'/>
					</div>
					<div class='intro-event-text'>
				...
				<div class='intro-event-info'>
					<div id='intro-event-logo' class='unselectable'>
						<img src='<?php bloginfo('template_url');?>/img/event-logo-dianyingke.svg'/>
					</div>
					<div class='intro-event-text'>
				...
				<div id='intro-photo-container'>
					<img id='intro-photo' src='<?php bloginfo('template_url');?>/img/events/电影节-1.jpg'/>
				</div>
			</div>
