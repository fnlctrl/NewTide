<div id='sidebar' class='unselectable ease'>
	...
	<div id='sidebar-sections'>
		...
		<div class='sidebar-section'><span>线下</span><hr>
			...
			<div id='sidebar-onepage' class='sidebar-item <?php if(is_category('一张纸')||in_category('一张纸')&&!is_home()) echo 'sidebar-item-current';?>' onclick='location.href="<?php echo home_url().'/category/onepage/'; ?>"'>　一张纸
