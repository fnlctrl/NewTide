...
<body>
	...
	<?php endif?>
			<div class='posts-wrapper ease'>
				<h1>编辑精选 <?php if(!$isMobile): ?>	<a class='more' href="<?php echo home_url().'/editors-picks'?>">更多...</a><?php endif;?></h1>
				<div class='posts-container'>
					...
					<?php if($isMobile): ?>	<a class='more' href="<?php echo home_url().'/editors-picks'?>">更多...</a><?php endif;?>
				</div>
